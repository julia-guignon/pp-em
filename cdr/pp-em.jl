...
function training_trotter_time_evolution(nl, layer, observable, training_thetas::Vector{Vector{Float64}}; noise_kind="none", min_abs_coeff=0.0, max_weight = Inf, noise_level = 1.0, depol_strength=0.02, dephase_strength=0.01)
