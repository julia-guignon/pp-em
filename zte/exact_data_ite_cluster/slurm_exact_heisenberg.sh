...
#SBATCH --output=/home/gerecke/pp-em/zte/exact_data_ite_cluster/output_heis/%j.out
#SBATCH --error=/home/gerecke/pp-em/zte/exact_data_ite_cluster/output_heis/%j.err
#SBATCH --qos=serial
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
srun julia --project=/home/gerecke/PauliProp data_generation_heisenberg.jl
